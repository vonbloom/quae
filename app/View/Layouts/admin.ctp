...
$cakeDescription = $parameters['Parameter']['title'].' Admin';
?>
<!DOCTYPE html>
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	    <ul class="nav navbar-nav">
		    ...
		    <li<?php if ($this->params['controller'] == 'parameters') echo ' class="active"';?>><?php echo $this->Html->link(__('Configuration'), array('controller' => 'parameters', 'action' => 'edit', 1, 'admin' => true));?></li>
	...
	<div class="content">
		<div class="col-lg-3">
			<?php echo ($this->params['controller'] != 'parameters') ? $this->element('admin_menu'):$this->element('parameters_menu'); ?>
			<?php echo ($this->params['controller'] != 'parameters') ? $this->element('options_menu'):''; ?>
		</div>
		<div class="col-lg-9">
...
<script>
	...
	<?php //debug ($this->data); ?>
	<?php //debug ($this->viewVars['parameters']['Parameter']['mail']); ?>
