...
<a href="products/show/desayuno"><?php echo str_replace("-", " ", ucfirst($pictures[$i]['Picture']['url']));?></a>
                             <?php
                                        $class = $this->params['pass'][0] == $pictures[$i]['Picture']['url'] ? $pictures[$i]['Picture']['url'].' active' : $pictures[$i]['Picture']['url'];

                                                        echo $this->Html->link(
                                                                str_replace("-", " ", ucfirst($pictures[$i]['Picture']['url'])),
                                                                array('controller' => 'products', 'action' => 'show', $pictures[$i]['Picture']['url']),
                                                                array('class' => $class, /*'data-rel' => $pictures[$i]['Picture']['url'], 'data-order' => $i+1*/)
                                                        );
                                                ?>
                        </li>
                    <?php endfor;?>
