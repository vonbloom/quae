...
$cakeDescription = $parameters['Parameter']['title'].' - '.$parameters['Parameter']['subtitle'].' |';
?>
<!DOCTYPE html>
...
<body>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<?php echo $this->Html->script('vendor/jquery.mousewheel.js');?>
	<?php echo $this->Html->script('plugins.js');?>
	<?php echo $this->Html->script('functions.js');?>
	<?php echo $this->Html->script('works.js');?>
